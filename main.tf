...
variable "params" {
  default = [
    ...
    {name = "roboshop.dev.frontend.payment_url", value = "http://shipping-dev.lipdevopspro.site:8080/", type = "String" },
    {name = "roboshop.dev.frontend.shipping_url", value = "http://payment-dev.lipdevopspro.site:8080/", type = "String" },*/
    ...
    {name = "roboshop.dev.dispatch.amqp_host", value = "rabbitmq-dev.lipdevopspro.site", type = "String" },
